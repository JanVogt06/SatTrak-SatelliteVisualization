...
```
cd existing_repo
git remote add origin https://git.uni-jena.de/se47toc/UnitySeminar.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.uni-jena.de/se47toc/UnitySeminar/-/settings/integrations)
